...
function Hero() {
  ...
  return (
    ...
    >
      <div className="bg-[#eee7dc9e] h-[85%] w-[80%] flex">
        <div className="flex flex-col gap-7 p-10 justify-center">
          <h1 className="font-bold text-5xl w-160 ">
        ...
        <div className="flex justify-center items-center">
          <img className="h-110 " src={logo} alt="" />
        </div>
      </div>
    </section>
  );
