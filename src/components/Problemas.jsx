...
function Problemas() {
  return (
    <section id="problemas" className="w-full h-180 flex justify-center items-center bg-[#eee7dc9e]">
      <div className=" h-[80%] w-[80%] items-center flex flex-col ">
        ...
        <div className="mt-8 gap-5 flex">
          <div className="bg-[#f6f6f6] shadow-xl h-120 w-120 p-5 py-10 rounded-2xl">
